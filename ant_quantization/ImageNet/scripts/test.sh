...
#Int
python -u -m torch.distributed.launch --nproc_per_node=1 --master_port 46666 main.py --dataset=cifar10 --model=vgg16_bn --epoch=2 --mode=int --wbit=4 --abit=4 --batch_size=128 --lr=0.0001 --train > ./log/vgg16_bn_Int.log 2>&1
